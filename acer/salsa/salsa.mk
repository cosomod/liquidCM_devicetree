#PRODUCT_COPY_FILES := \
#    device/acer/salsa/init.salsa.rc:root/init.salsa.rc
...
device/acer/salsa/dhcpcd.conf:system/etc/dhcpcd/dhcpcd.conf \
device/acer/salsa/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf

#device/acer/salsa/proprietary/etc/dhcpcd/dhcpcd-run-hooks:system/etc/dhcpcd/dhcpcd-run-hooks \
#device/acer/salsa/proprietary/etc/dhcpcd/dhcpcd-hooks/01-test:system/etc/dhcpcd/dhcpcd-hooks/01-test \
#device/acer/salsa/proprietary/etc/dhcpcd/dhcpcd-hooks/20-dns.conf:system/etc/dhcpcd/dhcpcd-hooks/20-dns.conf \
#device/acer/salsa/proprietary/etc/dhcpcd/dhcpcd-hooks/95-configured:system/etc/dhcpcd/dhcpcd-hooks/95-configured
...
LOCAL_KERNEL := device/acer/salsa/kernel
else
